...
import static stupaq.cloudatlas.query.semantics.values.SemanticValueTestUtils.L;
...
public class AbstractAggregateTest {
  private void testRandom(RColumn collection, int sampleSize, int resultSize) {
